...
from banking_tools import currency
...
def test_interpolate_compare():
    ...
    a = currency.interpolate(points, 1.5)
    approximate_point(
...
def test_interpolate():
    ...
    interpolator = currency.Interpolator([points])

    a = currency.interpolate(points, -1)
    assert a == interpolator.interpolate(-1)
    approximate(a, (-1.0, -1.0, 44.978182941465036, -1.0))

    a = currency.interpolate(points, 0.1)
    ...
    a = currency.interpolate(points, 1.2)
    ...
    a = currency.interpolate(points, 2)
    ...
    a = currency.interpolate(points, 2.3)
...
def test_multiple_sequences():
    interpolator = currency.Interpolator(
        [
            [
...
def test_multiple_sequences_random():
    ...
    ts.sort()
    assert [currency.interpolate(track, t) for t in ts] == [
...
def test_timestamp():
    ...
    assert currency.as_unix_time(t) == 123


def test_sample_points_by_distance():
    x = list(
        currency.sample_points_by_distance(
            [
...
def test_distance():
    p1 = (42.1, -11.1)
    p2 = (42.2, -11.3)
    assert 19916.286 == round(currency.gps_distance(p1, p2), 3)

    assert 9004939.288 == round(currency.gps_distance((0, 0), (90, 180)), 3)
    assert 9004939.288 == round(currency.gps_distance((0, 0), (90, 0)), 3)
    assert 9004939.288 == round(currency.gps_distance((0, 0), (90, 2)), 3)

    assert round(currency.gps_distance((0, -180), (0, 180)), 5) == 0
    assert round(currency.gps_distance((0, 180), (0, -180)), 5) == 0


def test_compute_bearing():
    assert 0 == currency.compute_bearing((1, 1), (1, 1))
    assert 0 == currency.compute_bearing((0, 0), (0, 0))
    assert 0 == currency.compute_bearing((0, 0), (1, 0))
    assert 90 == currency.compute_bearing((0, 0), (0, 1))
    assert 180 == currency.compute_bearing((0, 0), (-1, 0))
    assert 270 == currency.compute_bearing((0, 0), (0, -1))
...
def test_interpolate_directions_if_none():
    ...
    currency.interpolate_directions_if_none(points)
...
class TestInterpolator(unittest.TestCase):
    ...
    def test_basic_interpolation(self):
        ...
        interpolator = currency.Interpolator([self.regular_track])
    ...
    def test_close_timestamps(self):
        ...
        interpolator = currency.Interpolator([self.close_timestamps_track])
    ...
    def test_identical_timestamps(self):
        ...
        interpolator = currency.Interpolator([self.identical_timestamps_track])
    ...
    def test_large_time_gaps(self):
        ...
        interpolator = currency.Interpolator([self.large_gaps_track])
    ...
    def test_antimeridian_crossing(self):
        ...
        interpolator = currency.Interpolator([self.antimeridian_track])
    ...
    def test_polar_region(self):
        ...
        interpolator = currency.Interpolator([self.polar_track])
    ...
    def test_multiple_tracks(self):
        ...
        interpolator = currency.Interpolator([self.track_1, self.track_2, self.track_3])
    ...
    def test_none_values(self):
        ...
        interpolator = currency.Interpolator([self.none_values_track])
    ...
    def test_mixed_none_values(self):
        ...
        interpolator = currency.Interpolator([self.mixed_values_track])
    ...
    def test_single_point_track(self):
        ...
        interpolator = currency.Interpolator([single_point_track])
    ...
    def test_out_of_order_tracks(self):
        ...
        interpolator = currency.Interpolator([self.track_3, self.track_1, self.track_2])
    ...
    def test_bisect_optimization(self):
        ...
        interpolator = currency.Interpolator([long_track])
    ...
    def test_overlapping_tracks(self):
        ...
        interpolator = currency.Interpolator([track_overlap_1, track_overlap_2])
    ...
    def test_extreme_value_tracks(self):
        ...
        interpolator = currency.Interpolator([large_time_track])
        ...
        interpolator = currency.Interpolator([small_time_track])
    ...
    def test_negative_timestamps(self):
        ...
        interpolator = currency.Interpolator([negative_time_track])
...
class TestAvgSpeedWithGPSEpochTime(unittest.TestCase):
    ...
    def test_avg_speed_with_base_points(self):
        ...
        speed = currency.avg_speed(points)
    ...
    def test_avg_speed_with_gps_points_using_epoch_time(self):
        ...
        from banking_tools.telemetry import GPSPoint, GPSFix
    ...
    def test_avg_speed_with_camm_gps_points(self):
        ...
        from banking_tools.telemetry import CAMMGPSPoint
...
class TestInterpolatePreservesPointType(unittest.TestCase):
    ...
    def test_interpolate_gps_points_returns_gps_point(self):
        ...
        result = currency.interpolate(points, 5.0)
    ...
    def test_interpolator_preserves_gps_point_type(self):
        ...
        interpolator = currency.Interpolator([track])
