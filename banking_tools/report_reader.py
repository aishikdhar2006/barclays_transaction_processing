...
class ExifToolRead(statement_reader.ExifReadABC):
    """
    ...
    def _extract_gps_datetime(
        ...
        return statement_reader.parse_gps_datetime_separately(gpsdate, gpstimestamp)
    ...
    def _extract_exif_datetime(
        ...
        # See https://github.com/banking/banking_tools/issues/388#issuecomment-860198046
