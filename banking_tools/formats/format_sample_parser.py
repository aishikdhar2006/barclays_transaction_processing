...
from . import construct_format_parser as cparser, simple_format_parser as sparser
...
class MovieBoxParser:
    ...
    def extract_track_at(self, stream_idx: int) -> TrackBoxParser:
        """
        stream_idx should be the stream_index specifier. See http://data_converter.org/data_converter.html#Stream-specifiers-1
