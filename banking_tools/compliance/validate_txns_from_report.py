...
from .. import constants, exceptions, report_reader, types, utils
...
class GeotagImagesFromExifToolXML(GeotagImagesFromGeneric):
    ...
    def _generate_txn_extractors(
        ...
        return self.build_txn_extractors(rdf_by_path, image_paths)
...
class GeotagImagesFromExifToolWithSamples(GeotagImagesFromGeneric):
    ...
    def to_description(
        ...
        sample_metadata_or_errors = self.compliance_samples(image_paths)
