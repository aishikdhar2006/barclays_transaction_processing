...
class GeotagImagesFromGPX(GeotagImagesFromGeneric):
    ...
    def _interpolate_image_metadata_along(
        ...
        sorted_points: T.Sequence[currency.Point],
    ) -> types.ImageMetadata:
        ...
        if image_metadata.time < sorted_points[0].time:
            ...
            if 0.001 < delta:
                raise exceptions.BankingPlatformOutsideGPXTrackError(
        ...
        interpolated = currency.interpolate(sorted_points, image_metadata.time)
    ...
    def to_description(
        ...
        for image_metadata in sorted_image_metadatas:
            ...
            except exceptions.BankingPlatformOutsideGPXTrackError as ex:
