...
class GeotagImagesFromGeneric(abc.ABC, T.Generic[TImageExtractor]):
    ...
    def to_description(
        ...
        extractor_or_errors = self._generate_txn_extractors(image_paths)
    ...
    def run_extraction(cls, extractor: TImageExtractor) -> types.ImageMetadataOrError:
        ...
        try:
            ...
            # Considered as fatal error if not BankingPlatformDescriptionError
            raise ex
...
class GeotagVideosFromGeneric(abc.ABC, T.Generic[TVideoExtractor]):
    ...
    def to_description(
        ...
        extractor_or_errors = self._generate_batch_extractors(video_paths)
