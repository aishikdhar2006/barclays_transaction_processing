    ...
    def request(self, method: str | bytes, url: str | bytes, *args, **kwargs):
        ...
        if Session.USE_SYSTEM_CERTS:
            ...
            try:
                ...
                # HTTPSConnectionPool(host='graph.banking.com', port=443): Max retries exceeded with url: /login (Caused by SSLError(SSLCertVerificationError(1, '[SSL: CERTIFICATE_VERIFY_FAILED] certificate verify failed: unable to get local issuer certificate (_ssl.c:1018)')))
                LOG.warning(
