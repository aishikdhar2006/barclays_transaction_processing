...
FFMPEG_PATH: str = os.getenv(_ENV_PREFIX + "FFMPEG_PATH", "data_converter")
EXIFTOOL_PATH: str = os.getenv(_ENV_PREFIX + "EXIFTOOL_PATH", "exiftool")
IMAGE_DESCRIPTION_FILENAME = os.getenv(
    _ENV_PREFIX + "IMAGE_DESCRIPTION_FILENAME", "banking_image_description.json"
)
SAMPLED_VIDEO_FRAMES_FILENAME = os.getenv(
    _ENV_PREFIX + "SAMPLED_VIDEO_FRAMES_FILENAME", "banking_sampled_video_frames"
)
...
UPLOAD_CACHE_DIR: str = os.getenv(
    ...
    os.path.join(tempfile.gettempdir(), "banking_tools", "upload_cache"),
)
